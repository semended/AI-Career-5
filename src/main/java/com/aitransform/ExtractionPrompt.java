...
public final class ExtractionPrompt {
    ...
    public static String build(List<String> skills) {
        ...
        return "You extract required programming skills for a specific job role.\n\n"
                + "You are given a JSON array containing many vacancies for the same role. "
                + "Each vacancy includes fields like title, description, skills, responsibilities, requirements, and other text.\n\n"
